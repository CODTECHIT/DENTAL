        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 py-16 sm:py-20 lg:py-28 w-full z-10">
          <div className="max-w-2xl lg:max-w-3xl animate-reveal">
            ...
            <p className="mt-5 sm:mt-8 max-w-xl text-white/90 text-sm sm:text-lg md:text-xl leading-relaxed font-light drop-shadow">
              ...
              technology to deliver results that last.
            </p>

            <div className="mt-7 sm:mt-10 flex flex-wrap items-center gap-3 sm:gap-5">
              <Link
                to="/contact"
                className="group inline-flex items-center justify-center gap-2 bg-gradient-gold text-white font-semibold px-6 sm:px-9 py-3.5 sm:py-4 rounded-full shadow-lg shadow-gold/30 hover:shadow-gold/50 hover:scale-[1.03] transition-all duration-300 text-sm sm:text-base"
              >
                <Calendar className="w-4 sm:w-5 h-4 sm:h-5 shrink-0" />{" "}
                <span>Request an Appointment</span>
                <ChevronRight className="w-4 h-4 group-hover:translate-x-1 transition-transform shrink-0" />
              </Link>
              <Link
                to="/services"
                className="inline-flex items-center justify-center gap-2 text-white bg-white/10 backdrop-blur-md border border-white/25 hover:border-gold hover:text-gold hover:bg-white/15 font-medium px-6 sm:px-8 py-3.5 sm:py-4 rounded-full transition-all duration-300 text-sm sm:text-base shadow-sm"
              >
                Explore Services
              </Link>
            </div>
      ...
      <div className="relative bg-ink border-t border-white/10 z-20">
        <div className="max-w-7xl mx-auto px-4 grid grid-cols-2 md:grid-cols-4">
          {[
            ...
            <div
              key={s.l}
              className={`py-8 md:py-10 text-center ${i > 0 ? "md:border-l border-white/10" : ""} ${i % 2 === 1 ? "border-l border-white/10 md:border-l" : ""}`}
            >
              <div className="font-display text-4xl md:text-5xl lg:text-6xl text-white font-semibold">
                <Counter to={s.n} />
                <span className="text-gold">{s.s}</span>
              </div>
              <div className="mt-2 text-[11px] md:text-xs uppercase tracking-[0.2em] text-white/70 font-medium">
                {s.l}
              </div>
            </div>
          ))}
          ...
          <div className="reveal bg-white/5 backdrop-blur-md border border-white/15 rounded-2xl md:rounded-full px-5 sm:px-8 py-5 sm:py-6 grid grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 shadow-xl">
            {highlights.map((h) => (
              <div key={h.title} className="flex items-center gap-3.5 sm:justify-center group">
                ...
                <div className="text-xs sm:text-sm font-bold text-white/95 leading-snug">
                  {h.title}
                </div>
              </div>
            ))}
  ...
  return (
    <section className="relative overflow-hidden bg-ink text-white">
      <div className="absolute inset-0">
        <img
          src={clinic}
          alt="Sri Shobh Dental clinic interior in Tukkuguda"
          loading="lazy"
          decoding="async"
      ...
      <div className="relative max-w-7xl mx-auto px-4 py-16 sm:py-20 md:py-28 text-center animate-reveal">
        ...
        {subtitle && (
          <p className="mt-4 max-w-2xl mx-auto text-white/70 text-sm sm:text-base">{subtitle}</p>
        )}
      </div>
    </section>
  );
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6">
        <div className="text-center max-w-3xl mx-auto reveal">
          ...
          <h2 className="mt-4 font-display font-medium text-3xl sm:text-4xl md:text-5xl text-ink leading-tight">
            ...
            <span className="text-gold">in Tukkuguda</span>
          </h2>
          <p className="mt-4 text-sm sm:text-base text-muted-foreground">
            Traditional craftsmanship meets cutting-edge technology to deliver dentistry with
        ...
        <div className="mt-12 sm:mt-16 md:mt-20 space-y-12 sm:space-y-16 md:space-y-24">
          {items.map((it, i) => (
            <div
              key={it.title}
              className={`reveal grid md:grid-cols-2 gap-6 sm:gap-10 md:gap-14 items-center ${i % 2 ? "md:[&>*:first-child]:order-2" : ""}`}
            >
              <div className="relative group">
                ...
                <div className="relative rounded-2xl sm:rounded-3xl overflow-hidden shadow-gold ring-1 ring-gold/20">
                  <img
                    ...
                    loading="lazy"
                    decoding="async"
                    className="w-full h-[240px] sm:h-[320px] md:h-[400px] object-cover group-hover:scale-105 transition-transform duration-700"
                  />
                </div>
              </div>
              <div className="mt-2 md:mt-0">
                ...
                <h3 className="mt-2 sm:mt-3 font-display font-medium text-xl sm:text-2xl md:text-4xl text-ink leading-tight">
                  {it.title}
                </h3>
                <p className="mt-3 sm:mt-4 text-sm sm:text-base text-ink/70 leading-relaxed max-w-md">
                  {it.body}
                </p>
                <Link
                  to="/about"
                  className="mt-5 sm:mt-6 inline-flex items-center gap-2 text-sm font-semibold text-gold-dark hover:text-gold transition-colors group/link"
                >
                  Know more{" "}
  ...
  return (
    <section className="relative py-16 sm:py-20 md:py-28 bg-ink text-white overflow-hidden">
      <div className="absolute inset-0 opacity-20">
        <img
          src={clinic}
          alt="Sri Shobh Dental clinic background Tukkuguda"
          loading="lazy"
          decoding="async"
      ...
      <div className="relative max-w-4xl mx-auto px-4 sm:px-6 text-center reveal">
        ...
        <blockquote className="mt-4 font-display italic text-xl sm:text-2xl md:text-4xl leading-snug text-white">
          Dentistry isn't just about fixing teeth. It's about restoring confidence, comfort and
          trust patient by patient, smile by smile.
        </blockquote>
        <div className="mt-6 sm:mt-8 flex items-center justify-center gap-3 text-sm">
          <span className="w-8 sm:w-10 h-px bg-gold" />
          <span className="tracking-[0.2em] uppercase text-gold text-[10px] sm:text-xs">
            Sri Shobh Dental Founding Vision
          </span>
          <span className="w-8 sm:w-10 h-px bg-gold" />
        </div>
      </div>
    ...
    <Link to="/services/$slug" params={{ slug }}>
      ...
      >
        ...
        <div className="p-4 md:p-5 text-center flex-1 flex flex-col">
          ...
          <p className="mt-2 text-xs md:text-[13px] text-muted-foreground leading-relaxed flex-1">
            {desc}
          </p>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6">
        <div className="text-center max-w-2xl mx-auto reveal">
          ...
          <p className="mt-3 text-sm sm:text-base text-muted-foreground">
            Everything your family needs under one trusted roof.
          </p>
        </div>
        ...
        {limit && (
          <div className="mt-10 text-center reveal">
            <Link
              to="/services"
              className="inline-flex items-center gap-2 bg-gradient-gold text-white font-semibold px-8 py-3.5 rounded-full shadow-gold hover:scale-[1.03] transition-transform text-sm sm:text-base"
            >
          ...
          <div className="mt-8 grid grid-cols-2 sm:grid-cols-3 md:grid-cols-5 gap-6 sm:gap-8">
            {whyChoose.map((w, i) => (
              ...
              >
                ...
                <div className="mt-3 text-xs sm:text-sm font-bold text-ink leading-tight">
                  {w.title}
                </div>
              </div>
            ))}
    ...
    <section id="about" className="py-14 sm:py-20 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 grid lg:grid-cols-[1fr_1.4fr] gap-8 sm:gap-12 items-stretch">
        <div className="reveal relative">
          ...
          <img
            src={clinic}
            alt="Sri Shobh Dental clinic interior"
            width={1400}
            height={1000}
            loading="lazy"
            decoding="async"
            className="relative rounded-2xl sm:rounded-3xl w-full h-full min-h-[260px] sm:min-h-[320px] object-cover shadow-gold ring-1 ring-gold/20"
          />
        </div>
        <div className="reveal bg-white rounded-2xl sm:rounded-3xl border border-border p-6 sm:p-8 md:p-10">
          ...
          <h2 className="mt-3 font-display font-medium text-2xl sm:text-3xl md:text-4xl text-ink leading-tight">
            A premium, <span className="italic-accent">specialist-driven</span> dental home in{" "}
            <span className="text-gold">Tukkuguda</span>
          </h2>
          <p className="mt-4 text-sm sm:text-base text-muted-foreground leading-relaxed">
            Sri Shobh Dental & Implant Centre is committed to advanced, ethical and personalised
            care creating healthy, confident smiles with exceptional patient experiences.
          </p>
          ...
          <div className="mt-6 sm:mt-8 grid grid-cols-1 md:grid-cols-3 gap-4">
            <InfoBlock
              icon={Sparkles}
              title="Our Vision"
              body="To be Tukkuguda's most trusted dental clinic, delivering ethical, advanced and patient-centred care."
            />
            <InfoBlock
              icon={HeartPulse}
              title="Our Mission"
              body="To provide comprehensive specialist dental care with advanced technology and compassion."
            />
            <InfoBlock
              icon={Award}
      ...
      <div className="flex gap-8 animate-marquee whitespace-nowrap">
        {row.map((t, i) => (
          <div key={i} className="flex items-center gap-6 sm:gap-8 text-xs sm:text-sm shrink-0">
            ...
            <span className="font-display italic tracking-wide text-white/95 text-sm sm:text-base md:text-lg">
              {t}
            </span>
          </div>
        ))}
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6">
        <div className="text-center max-w-2xl mx-auto reveal">
          ...
          <h2 className="mt-4 font-display font-medium text-3xl sm:text-4xl md:text-5xl text-ink leading-tight">
            ...
            <span className="text-gold">from Tukkuguda</span>
          </h2>
          <p className="mt-3 text-sm sm:text-base text-muted-foreground">
            A glimpse at the smiles we've cared for and crafted.
          </p>
        </div>
          ...
          {imgs.map((item, i) => (
            ...
            >
              {item.type === "video" ? (
                ...
                <img
                  src={item.src}
                  alt="Dental treatment result at Sri Shobh Dental in Tukkuguda"
                  width={800}
                  height={600}
                  loading="lazy"
                  decoding="async"
        ...
        {limit && (
          <div className="mt-10 text-center reveal">
            <Link
              to="/gallery"
              className="inline-flex items-center gap-2 text-gold-dark hover:text-gold font-semibold text-sm sm:text-base"
            >
        ...
        >
          {active.type === "video" ? (
            <video
              ...
              controls
              autoPlay
              className="max-w-full max-h-full rounded-2xl shadow-gold ring-1 ring-gold/40"
            />
          ) : (
            <img
              src={active.src}
...
export function Testimonials() {
  const items = [
    {
      name: "Priya S.",
      text: "The team made my implants painless and my new smile feels completely natural. Truly caring specialists.",
    },
    {
      name: "Rahul K.",
      text: "Cleanest, most modern clinic in Tukkuguda. Explained every step and pricing upfront. Highly recommended.",
    },
    {
      name: "Anjali M.",
      text: "My kids love Dr. and the aligners transformed my confidence. Warm, professional and gentle throughout.",
    },
    {
      name: "Vikram T.",
      text: "Emergency root canal on a Sunday  they answered, treated me the same evening. Life savers.",
    },
  ];
          ...
          <div className="bg-white rounded-2xl sm:rounded-3xl border border-gold/20 shadow-soft p-6 sm:p-8 md:p-12 min-h-[220px] sm:min-h-[240px] flex flex-col justify-center">
            <div className="flex justify-center gap-1 text-gold">
              {Array.from({ length: 5 }).map((_, k) => (
                <Star key={k} className="w-4 sm:w-5 h-4 sm:h-5 fill-current" />
              ))}
            </div>
            <p
              key={i}
              className="mt-5 sm:mt-6 font-display italic text-base sm:text-lg md:text-2xl text-ink leading-snug animate-reveal"
            >
              "{items[i].text}"
            </p>
            <div className="mt-5 sm:mt-6 text-xs sm:text-sm font-semibold text-gold-dark tracking-wider uppercase">
              {" "}
              {items[i].name}
            </div>
          </div>
    ...
    <section id="contact" className="py-14 sm:py-20 bg-background">
      <div className="max-w-7xl mx-auto px-4 sm:px-6">
        <div className="text-center max-w-2xl mx-auto reveal">
          ...
          <p className="mt-3 text-sm sm:text-base text-muted-foreground">
            Schedule a consultation with our specialists we'll be in touch within hours.
          </p>
        </div>
        ...
        <div className="mt-10 sm:mt-12 grid grid-cols-1 lg:grid-cols-5 gap-6 sm:gap-8">
          ...
          >
            ...
            <div className="mt-4 sm:mt-5">
              ...
              <select
                name="service"
                className="w-full h-11 sm:h-12 rounded-lg border border-border bg-background px-3.5 text-sm focus:outline-none focus:ring-2 focus:ring-gold/40 focus:border-gold"
              >
            ...
            <div className="mt-4 sm:mt-5">
              ...
              <textarea
                name="message"
                rows={4}
                className="w-full rounded-lg border border-border bg-background px-3.5 py-3 text-sm focus:outline-none focus:ring-2 focus:ring-gold/40 focus:border-gold"
                placeholder="Tell us briefly about your concern..."
              />
            </div>
            <button
              type="submit"
              className="mt-6 sm:mt-7 group w-full sm:w-auto inline-flex items-center justify-center gap-2 bg-gradient-gold text-white font-semibold px-8 py-4 rounded-full shadow-gold hover:scale-[1.02] transition-transform text-sm sm:text-base"
            >
            ...
            {sent ? (
              <p className="mt-4 text-xs sm:text-sm text-gold-dark font-semibold flex items-center gap-1.5 animate-reveal">
                <CheckCircle2 className="w-4 h-4 text-gold" /> Opening WhatsApp we'll respond
                shortly!
              </p>
            ) : (
              <p className="mt-4 text-xs sm:text-sm text-muted-foreground flex items-center gap-1.5">
                <ShieldCheck className="w-4 h-4 text-gold" /> We'll get back to you within a few
                hours.
              </p>
            )}
          </form>
      ...
      <div className="max-w-7xl mx-auto px-4 relative z-10">
        <div className="max-w-3xl mx-auto text-center mb-16 md:mb-24">
          <h2 className="font-display text-4xl md:text-5xl lg:text-6xl text-ink font-semibold mb-6">
            ...
            <span className="text-gold-dark">in Tukkuguda</span>
          </h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {specialists.map((doc, i) => (
            <div
              key={doc.name}
              className="group bg-white rounded-2xl shadow-soft border border-border hover:border-gold/30 hover:shadow-gold transition-all duration-500 flex flex-col h-full overflow-hidden"
            >
              <div className="aspect-[4/3] sm:aspect-square relative overflow-hidden bg-ink/5">
                ...
                <div className="absolute bottom-0 left-0 right-0 p-6 md:p-8">
                  <div className="text-gold font-medium mb-1 drop-shadow-md">
                    {doc.qualifications}
                  </div>
                  <h3 className="font-display text-2xl md:text-3xl text-white font-semibold drop-shadow-md">
                    {doc.name}
                  </h3>
                </div>
              </div>
              ...
              <div className="p-6 md:p-8 flex flex-col flex-1">
                ...
                <div className="mt-auto pt-6 border-t border-border">
                  <div className="text-xs uppercase tracking-widest text-ink/50 mb-4">
                    Areas of Expertise
                  </div>
